...
public class Personaje {
	...
	Personaje(double x, double y){
		...
		this.velocidad=2.0;
		this.escala=0.35;
		izq = Herramientas.cargarImagen("personaje2.gif");
		der = Herramientas.cargarImagen("personaje.gif");
		up = Herramientas.cargarImagen("salto.gif");
		downDer = Herramientas.cargarImagen("downDer.gif");
		downIzq = Herramientas.cargarImagen("downIzq.gif");
		quietoDer = Herramientas.cargarImagen("quietoDer.gif");
		quietoIzq = Herramientas.cargarImagen("quietoIzq.gif");
		caidaDer = Herramientas.cargarImagen("caidaDer.gif");
		caidaIzq = Herramientas.cargarImagen("caidaIzq.gif");
		disparoDer = Herramientas.cargarImagen("disparoDer.gif");
		disparoIzq = Herramientas.cargarImagen("disparoIzq.gif");
	...
	public void dibujar(Entorno e) {
		if (saltando) {
			...
			if (direccion) {
				e.dibujarImagen(this.disparoIzq, this.x, this.y, 0, this.escala);
			}
			else {
				e.dibujarImagen(this.disparoDer, this.x, this.y, 0, this.escala);
			}
		}
		else if (agachado) {
			if (direccion) {
